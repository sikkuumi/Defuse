...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  @keyframes grow{0%{transform:scaleY(0);opacity:0}8%{opacity:1}54%{transform:scaleY(1)}92%{transform:scaleY(1);opacity:1}100%{transform:scaleY(1);opacity:0}}
  @keyframes node{0%,8%{opacity:.18;transform:scale(.74)}20%{opacity:1;transform:scale(1)}92%{opacity:1;transform:scale(1)}100%{opacity:.18;transform:scale(.74)}}
  ...
  .card{padding:34px 32px 30px;border-radius:16px}
  ...
  .quote{font-size:clamp(21px,2.6vw,27px);font-weight:500;letter-spacing:-.6px;line-height:1.24;color:var(--white);margin:22px 0 0}
  .card.guessed .quote{color:var(--mute)}
  .meta{border-top:1px solid var(--hair);margin-top:24px;padding-top:18px;font-family:"IBM Plex Mono",monospace;font-size:12px;color:var(--faint);line-height:1.9}
  ...
  <div class="wrap">
    ...
    <div class="proof">
      ...
      <div class="trace glass">
        ...
        <div class="hop">
          <span class="n" style="animation-delay:1.4s"></span>
        ...
        <div class="hop">
          <span class="n on" style="animation-delay:2.8s"></span>
  ...
  <div class="wrap">
    ...
    <div class="two">
      <div class="card proven">
        <div style="display:flex;align-items:center;gap:12px"><span class="dot" style="width:11px;height:11px"></span><span class="mono" style="font-size:16px;color:var(--white)">flow-verified</span></div>
        <p class="quote">“Attacker data actually reaches here.”</p>
        <p style="margin-top:16px;font-size:15px">Traced hop by hop, across functions and across files, with
      ...
      <div class="card guessed">
        <div style="display:flex;align-items:center;gap:12px"><span class="ring" style="width:11px;height:11px"></span><span class="mono" style="font-size:16px;color:var(--mute)">signature-based</span></div>
        <p class="quote">“This code has the shape of a bug.”</p>
        <p style="margin-top:16px;font-size:15px">A pattern matched in the syntax tree. Data flow was not
